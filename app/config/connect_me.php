...
{
$this->conn = NULL; // Setting the handler to NULL closes the connection propperly
}

}

/**
* I've tried to make that possible. No one can directly access this page
* Hope I did well!
*/
class Control_Access013 extends connect_me
{
...
/** Do not change or replace code it makes secures your page  */
